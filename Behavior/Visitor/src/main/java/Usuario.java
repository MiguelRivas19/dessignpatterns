import elements.Empresa;
import elements.EmpresaMadre;
import elements.EmpresaSinFilial;
import visitor.VisitanteMailingComercial;
...
public class Usuario {
    ...
    public static void main(String[] args) {
        ...
        Empresa grupo1 = new EmpresaMadre("grupo1", "info@grupo1.com", "calle de la grupo 1");
        ...
        Empresa grupo2 = new EmpresaMadre("grupo2", "info@grupo2.com", "calle de la grupo 2");
